...
int main(int argc, char *argv[]) {
    ...
    if (sem_init(&sem_a, 0, 0) != 0) { perror("sem_init A"); return 1; }
    if (sem_init(&sem_b, 0, 0) != 0) { perror("sem_init B"); return 1; }
    if (sem_init(&sem_c, 0, 0) != 0) { perror("sem_init C"); return 1; }
    if (sem_init(&sem_module, 0, 0) != 0) { perror("sem_init Module"); return 1; }
